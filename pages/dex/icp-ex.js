      ...
      <title>ICPEx | ICP DEX</title>
			...
			<div className="flex flex-col md:flex-row md:items-center p-5">
                ...
                <div className="flex-1 flex flex-col items-center md:max-w-max max-w-[110px]">
                        <h3 className="text-xl font-bold"><span class="hidden md:inline">Total Value Locked</span> <span class="inline md:hidden block">TVL</span>:  {tvlAndVolumeData.icpex?.tvl}</h3>	
