                   ...
                   {/* Image Section */}
                    <div className="flex-2 flex justify-center items-center flex-col p-2">
                        ...
                        <div className="mt-4 flex justify-center space-x-6">
                            <a href="https://discord.com/invite/FQZFGGq7zv" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-600">
                                <FaDiscourd size={30} />
                            </a>
                            <a href="https://x.com/ICLighthouse" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:text-blue-800">
                                <FaTwitter size={30} />
                            </a>				
                            <a href="https://medium.com/@ICLighthouse" target="_blank" rel="noopener noreferrer" className="text-blue-900 hover:text-blue-800">
                                <FaMedium size={30} />
                            </a>
                            <a href="https://iclight.house" target="_blank" rel="noopener noreferrer" className="text-blue-900 hover:text-blue-800">
                                <FaGlobe size={30} />
                            </a>
                        </div>	
                    </div>				
