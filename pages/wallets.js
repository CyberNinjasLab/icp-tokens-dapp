...
const Dex = () => {
	return (
      ...
      <Head>
		...
		<meta name="description" content="Explore top ICP wallets for secure management of tokens, NFTs, and DeFi assets. Discover wallets like Plug, Stoic, and more, tailored for the Internet Computer ecosystem."></meta>
      </Head>
			<Layout>
