...
import PortfolioTransactionsTableOld from '../../../../ui/components/portfolio/PortfolioTransactionsTableOld';
...
import TokenTransactionsSummaryOld from '../../../../ui/components/portfolio/TokenTransactionsSummaryOld';
            ...
            <div className='min-h-[300px]'>
                ...
                { isAuthenticated && loaded && summaries.tokens && (
                    <div>
                        ...
                        <div>
                            <TokenTransactionsSummaryOld summary={summaries} token={token} />
                        </div>
                        {summaries.tokens.length && (
                            <PortfolioTransactionsTableOld summary={summaries} fetchPortfolios={fetchPortfolios} />
                        )}
                    </div>
                )}
            </div>
