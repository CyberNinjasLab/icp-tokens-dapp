...
const Nft = () => {
	return (
      ...
      <Head>
		...
		<link rel="canonical" href="https://icptokens.net/nft" />
      </Head>
			<Layout>
				<div className='w-full'>
					<h1 className='h1'>ICP NFT</h1>
					<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-4">
						<a href="https://entrepot.app/" target="_blank" className="max-w-sm mx-auto p-6 w-full shadow-lg dark:bg-gray-500/20 rounded-lg">
							<div className="flex items-center space-x-4">
								<img src="/logos/entrepot_logo.webp" alt="Entrepot Logo" className="h-12 w-12 rounded-full" />
								<h2 className="font-bold text-lg">Entrepot</h2>
							</div>
							<div className="mt-4">
								<h3 className="font-semibold mb-1">Decentralized NFT Marketplace</h3>
						...
						<a href="https://bioniq.io/" target="_blank" className="max-w-sm mx-auto p-6 w-full shadow-lg dark:bg-gray-500/20 rounded-lg">
							<div className="flex items-center space-x-4">
								<img src="/logos/bioniq-logo.jpeg" alt="Bioniq Logo" className="h-12 w-12 rounded-full" />
								<h2 className="font-bold text-lg">Bioniq</h2>
							</div>
							<div className="mt-4">
								<h3 className="font-semibold mb-1">Fastest Ordinals Marketplace</h3>
						...
						<a href="https://yumi.io/" target="_blank" className="max-w-sm mx-auto p-6 w-full shadow-lg dark:bg-gray-500/20 rounded-lg">
							<div className="flex items-center space-x-4">
								<img src="/logos/yumi_logo.webp" alt="Yumi NFT Market Logo" className="h-12 w-12 rounded-full" />
								<h2 className="font-bold text-lg">Yumi</h2>
							</div>
							<div className="mt-4">
								<h3 className="font-semibold mb-1">High-Speed NFT Marketplace</h3>
						...
						<a href="https://yuku.app/" target="_blank" className="max-w-sm mx-auto p-6 w-full shadow-lg dark:bg-gray-500/20 rounded-lg">
							<div className="flex items-center space-x-4">
								<img src="/logos/yuku_logo.png" alt="YUKU NFT Market Logo" className="h-12 w-12 rounded-full" />
								<h2 className="font-bold text-lg">Yuku</h2>
							</div>
							<div className="mt-4">
								<h3 className="font-semibold mb-1">AI Web3 Platform</h3>
						...
						<a href="https://dgdg.app/" target="_blank" className="max-w-sm mx-auto p-6 w-full shadow-lg dark:bg-gray-500/20 rounded-lg">
							<div className="flex items-center space-x-4">
								<img src="/logos/dgdg-nft.webp" alt="Multi-chain NFT Aggregator Logo" className="h-12 w-12 rounded-full" />
								<h2 className="font-bold text-lg">DGDG</h2>
							</div>
							<div className="mt-4">
								<h3 className="font-semibold mb-1">Multi-chain NFT Aggregator</h3>
