  ...
  const { isAuthenticated } = useContext(AuthContext);
    ...
    <>
      <Head>
        ...
        <meta name="description" content="Create a personalized watchlist for ICP Tokens. Track your favorite tokens in real-time and stay updated on price changes within the Internet Computer ecosystem."></meta>
