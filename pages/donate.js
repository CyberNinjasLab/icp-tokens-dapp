    ...
    return (
        <Layout>
            <div className='w-full text-center md:mt-6'>
                ...
                <div className='mt-8 '>
                    <div className='border-gray-500 bg-gray-900/60 border shadow-xl rounded-xl inline-block px-4 py-6 lg:px-10 lg:py-8 min-w-[440px]'>
                        <ToggleButtonGroup
                            value={toggleValue}
                            exclusive
                            onChange={(event, currentSelection) => setToggleValue(currentSelection)}
                            color="primary"
                            sx={{
                                gap: '10px',
                                flexWrap: 'wrap',
                        ...
                        >
                            ...
                            {/* <Tooltip title="ckBTC Token">
                                <ToggleButton value="ckBTC">
                                    <img src="/tokens/ckBTC.png" className='w-6 h-6 mr-2' />
                                    ckBTC
                                </ToggleButton>
                            </Tooltip>
                            <Tooltip title="ckUSDC Token">
                                <ToggleButton value="ckUSDC">
                                    <img src="/tokens/ckUSDC.svg" className='w-6 h-6 mr-2' />
                                    ckUSDC
                                </ToggleButton>
                            </Tooltip> */}
                        </ToggleButtonGroup>
                        <div className='mt-6 text-center mb-4'>
                            <div>
                                ...
                                <div className='mt-3'>
                                    <span className='relative inline-block break-words leading-4 max-w-[270px]'>
                                        {isICP 
                                        ...
                                        <span className='inline-block absolute left-full top-1/2 transform -translate-y-1/2 ml-2'>
